var GameState = {
    ...
    create:function(){
        ...
        this.game.add.text(140, 20, 'Happiness:', style);

        this.healthText = this.game.add.text(85, 20, '', style);
        this.funText = this.game.add.text(240, 20, '', style);
    ...
    rotatePet: function(sprite, item){
        if(!this.uiBlocked){
